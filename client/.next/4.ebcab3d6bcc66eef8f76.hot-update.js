  ...
  _createClass(Web3Container, [{
    ...
    value: function () {
      ...
      __WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator___default.a.mark(function _callee() {
        var web3, contract, accounts, _name, _symbol, _totalSupply, _currentAccount, _accountBalance;
        ...
        return __WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 15:
                _symbol = _context.sent;
                _context.next = 18;
                return contract.methods.totalSupply().call();

              case 18:
                _totalSupply = _context.sent;
                _currentAccount = accounts[0];
                _context.next = 22;
                return contract.methods.balanceOf(_currentAccount).call();

              case 22:
                _accountBalance = _context.sent;
                this.setState({
                  web3: web3,
                  contract: contract,
                  accounts: accounts,
...
//# sourceMappingURL=4.ebcab3d6bcc66eef8f76.hot-update.js.map