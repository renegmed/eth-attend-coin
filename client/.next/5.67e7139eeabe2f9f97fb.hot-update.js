    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_ref = TransferForm.__proto__ || Object.getPrototypeOf(TransferForm)).call.apply(_ref, [this].concat(args))), Object.defineProperty(_assertThisInitialized(_this), "state", {
      ...
      value: function () {
        ...
        __WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator___default.a.mark(function _callee(event) {
          var _this$props, web3, contract, currentAccount, accounts, result;
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  console.log('+++++++ to: ', _this.state.to);
                  console.log('+++++++ tokens: ', _this.state.tokens); // const web3 = await getWeb3()     
                ...
                case 12:
                  ...
                  _context.next = 17;
                  return contract.methods.transferFrom(currentAccount, _this.state.to, _this.state.tokens).send({
                    from: accounts[0]
                  });
                ...
                case 22:
                  ...
                  console.log(_context.t0.errorMessage);
...
//# sourceMappingURL=5.67e7139eeabe2f9f97fb.hot-update.js.map