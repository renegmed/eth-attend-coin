  ...
  _createClass(Transfer, [{
    ...
    value: function () {
      ...
      __WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator___default.a.mark(function _callee(props) {
        var _props, web3, contract, currentAccount, accountBalance;

        return __WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _props = this.props, web3 = _props.web3, contract = _props.contract, currentAccount = _props.currentAccount, accountBalance = _props.accountBalance;
...
//# sourceMappingURL=5.99bfb85c4b1fb8703ea0.hot-update.js.map